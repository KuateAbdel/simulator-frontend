...
export const translations = {
  fr: {
    ...
    nav_group_attribution: 'Attribution',
    nav_attr_vue: "Vue d'ensemble",
    // Écran Baux actifs (DASH §5.2) — le vocabulaire de la diapo 7 est LA
    // règle : « Numéro attribué » jamais MSISDN, « Rattachée au kiosque »
    // jamais « active chez », « Non renseigné » jamais un tiret.
    attr_baux_titre: 'Baux actifs',
    attr_baux_soustitre:
      'Qui détient quel numéro, sur quel appareil, et combien de temps reste-t-il.',
    attr_col_interlocuteur: 'Interlocuteur',
    attr_col_numero: 'Numéro attribué',
    attr_col_profil: 'Profil',
    attr_col_appareil: 'Appareil',
    attr_col_territoire: 'Territoire',
    attr_col_attribue: 'Attribué le',
    attr_col_reste: 'Reste',
    attr_non_renseigne: 'Non renseigné',
    attr_echu: 'Échu',
    attr_recherche: 'Interlocuteur, numéro ou appareil…',
    attr_corresp_interlocuteur: 'interlocuteur',
    attr_corresp_numero: 'numéro',
    attr_corresp_appareil: 'appareil',
    attr_filtre_pays: 'Pays',
    attr_filtre_tous_pays: 'Tous les pays',
    attr_filtre_etat: 'État',
    attr_etat_actifs: 'Actifs',
    attr_etat_echus: 'Échus (30 j)',
    attr_etat_tous: 'Tous',
    attr_filtre_echeance: 'Échéance',
    attr_echeance_toutes: 'Toutes',
    attr_echeance_24h: 'Sous 24 h',
    attr_echeance_48h: 'Sous 2 jours',
    attr_reprendre: 'Reprendre',
    attr_reprendre_selection: 'Reprendre la sélection',
    attr_reprise_titre: 'Reprendre ce bail ?',
    attr_reprise_titre_lot: 'Reprendre {n} baux ?',
    attr_reprise_rappel:
      'Le numéro retournera immédiatement au pool et l’appareil le découvrira à sa prochaine vérification.',
    attr_reprise_motif: 'Motif (obligatoire, tracé au journal)',
    attr_reprise_confirmer: 'Reprendre le bail',
    attr_reprise_confirmer_lot: 'Reprendre les baux',
    attr_reprise_faite: 'Bail repris — le numéro est retourné au pool',
    attr_reprise_lot_faite: '{ok} repris · {ko} sans bail actif',
    attr_reprise_super_admin: 'Reprise réservée au rôle Super-Admin',
    attr_interlocuteur_enregistre: 'Interlocuteur enregistré',
    attr_interlocuteur_efface: 'Interlocuteur effacé',
    attr_exporter: 'Exporter (CSV)',
    attr_rafraichir: 'Rafraîchir',
    attr_vide_titre: 'Le système est prêt — aucune attribution en cours.',
    attr_vide_echus: 'Aucun bail échu sur les trente derniers jours.',
    attr_erreur_chargement: 'Le Loader ne répond pas. Les données affichées peuvent dater.',
    attr_fuseau: 'Heures affichées en heure locale ({tz}) — horloge de référence : le serveur.',
    attr_sous_ancien_reglage: 'accordé sous un ancien réglage de durée',
    annuler: 'Annuler',
    // Dossier client (DASH §5.3) — sept blocs, panneau latéral.
    dos_eyebrow: 'Numéro attribué',
    dos_fermer: 'Fermer le dossier',
    dos_ouvrir: 'Ouvrir le dossier',
    dos_identite: 'Identité',
    dos_territoire: 'Territoire',
    dos_compte: 'Compte',
    dos_releve: 'Relevé des opérations',
    dos_produits: 'Produits',
    dos_epargne: 'Épargne',
    dos_rattachement: 'Rattachée au kiosque',
    dos_solde: 'Solde — relu du compte',
    dos_solde_dispo: 'Disponible',
    dos_statut_compte: 'Statut du compte',
    dos_numero_compte: 'N° de compte',
    dos_momo: 'Mobile money direct',
    dos_oui: 'Oui',
    dos_non: 'Non',
    dos_langue: 'Langue',
    dos_segment: 'Segment',
    dos_nom: 'Nom',
    dos_naissance: 'Naissance',
    dos_situation: 'Situation familiale',
    dos_profession: 'Profession',
    dos_piece: 'Pièce d’identité',
    dos_piece_expire: 'expire le',
    dos_email: 'Courriel',
    dos_nationalite: 'Nationalité',
    dos_adresse: 'Adresse',
    dos_charger_releve: 'Afficher le relevé',
    dos_releve_vide: 'Aucune opération.',
    dos_reprendre_pied: 'Reprendre le bail',
    dos_frais: 'frais',
    // Population (DASH §5.4) — quelles combinaisons sont fragiles.
    apo_titre: 'Population',
    apo_soustitre:
      'Les combinaisons de profil, par pays — lesquelles peuvent encore servir un interlocuteur.',
    apo_libres: 'Libres',
    apo_attribues: 'Attribués',
    apo_total: 'Total',
    apo_epuisees: 'Combinaisons épuisées',
    apo_epuisee_ligne: 'Aucun interlocuteur de ce profil ne peut recevoir de numéro.',
    apo_vide:
      'Aucun client n’existe : le peuplement du Loader est requis. C’est l’état du système avant tout run réel.',
    apo_femme: 'Femme',
    apo_homme: 'Homme',
    apo_individuel: 'Particulier',
    apo_corporate: 'Entreprise',
    // Vue d'ensemble (DASH §5.1) — « est-ce que ça tient », en un regard.
    vue_titre: "Vue d'ensemble",
    vue_soustitre: 'Le système tient-il ? Où sont les tensions, que s’est-il passé.',
    vue_baux_actifs: 'Baux actifs',
    vue_expirant: 'Expirant sous 24 h',
    vue_disponibles: 'Clients disponibles',
    vue_epuisees: 'Combinaisons épuisées',
    vue_activite: 'Attributions — 7 derniers jours',
    vue_derniers: 'Derniers événements',
    vue_aucune_activite: 'Aucune attribution sur les sept derniers jours.',
    // Journal (DASH §5.5) — le vocabulaire de la diapo 7, mot pour mot.
    ajr_titre: 'Journal',
    ajr_soustitre:
      'Attributions, libérations, expirations et refus — trente jours glissants.',
    ajr_quand: 'Quand',
    ajr_evenement: 'Événement',
    ajr_numero: 'Numéro attribué',
    ajr_origine: 'Origine',
    ajr_detail: 'Détail',
    ajr_attribution: 'Attribution',
    ajr_rendu: 'Rendu par l’appareil',
    ajr_repris: 'Repris depuis l’administration',
    ajr_expiration: 'Expiration',
    ajr_refus: 'Aucun client disponible pour ce profil',
    ajr_nommage: 'Interlocuteur nommé',
    ajr_appareil: 'appareil',
    ...
    // Réglage de la durée du bail (contrat 0.4 §b) — super_admin.
    dur_bouton: 'Durée du bail',
    dur_titre: 'Durée du bail',
    dur_doctrine:
      'Résolue au moment du tirage. Les baux déjà attribués gardent leur échéance — un bail est une promesse datée.',
    dur_globale: 'Durée globale (jours)',
    dur_surcharges: 'Surcharges par pays',
    dur_surcharge_aucune: 'Aucune — tous les pays suivent la durée globale.',
    dur_ajouter_surcharge: 'Ajouter une surcharge',
    dur_enregistrer: 'Enregistrer',
    dur_super_admin: 'Réglage réservé au rôle Super-Admin',
    dur_enregistre: 'Durée enregistrée — {n} bail(s) actif(s) inchangé(s)',
    dur_jours: 'jours',
    dur_suivre_globale: 'suivre la durée globale',

    nav_attr_baux: 'Baux actifs',
    nav_attr_population: 'Population',
    nav_attr_journal: 'Journal',
    ...
    pur_date_inconnue: 'date inconnue — pas créé par nous',
    dep_pays: 'Pays',
    cmp_aucun_pays_operation: 'Aucun pays EN OPÉRATION sur la plateforme — une company ne peut naître que dans un pays qui y existe.',
    cmp_aller_pousser: 'Pousser un pays',
    cmp_pays_chargement: 'lecture des pays en opération…',
    cmp_pays_muet: 'config-service n’a pas répondu — impossible de savoir quels pays sont en opération. Rien n’est proposé plutôt qu’une liste devinée.',
    dep_etat_inconnu: 'état inconnu',
    dep_region: 'Région',
    dep_ville: 'Ville',
    dep_choisir_pays_dabord: 'choisir un pays d’abord',
    dep_choisir_region_dabord: 'choisir une région d’abord',
    dep_choisir_ville_dabord: 'choisir une ville d’abord',
    inv_col_cree_le: 'Créé le',
    eco_m_gini: 'Gini',
    ...
    eco_i_disparus: 'kiosque(s) disparu(s) de la plateforme',
    eco_non_verifie: 'Arbre NON vérifié contre la plateforme — depositary-service n’a pas répondu. Ce que vous voyez est notre mémoire du run, pas une confirmation de son existence là-bas.',
  ...
  en: {
    ...
    nav_administration: 'Administration',
    nav_group_attribution: 'Attribution',
    nav_attr_vue: 'Overview',
    attr_baux_titre: 'Active leases',
    attr_baux_soustitre: 'Who holds which number, on which device, and how long is left.',
    attr_col_interlocuteur: 'Contact',
    attr_col_numero: 'Assigned number',
    attr_col_profil: 'Profile',
    attr_col_appareil: 'Device',
    attr_col_territoire: 'Territory',
    attr_col_attribue: 'Assigned on',
    attr_col_reste: 'Time left',
    attr_non_renseigne: 'Not set',
    attr_echu: 'Expired',
    attr_recherche: 'Contact, number or device…',
    attr_corresp_interlocuteur: 'contact',
    attr_corresp_numero: 'number',
    attr_corresp_appareil: 'device',
    attr_filtre_pays: 'Country',
    attr_filtre_tous_pays: 'All countries',
    attr_filtre_etat: 'State',
    attr_etat_actifs: 'Active',
    attr_etat_echus: 'Expired (30 d)',
    attr_etat_tous: 'All',
    attr_filtre_echeance: 'Deadline',
    attr_echeance_toutes: 'All',
    attr_echeance_24h: 'Under 24 h',
    attr_echeance_48h: 'Under 2 days',
    attr_reprendre: 'Reclaim',
    attr_reprendre_selection: 'Reclaim selection',
    attr_reprise_titre: 'Reclaim this lease?',
    attr_reprise_titre_lot: 'Reclaim {n} leases?',
    attr_reprise_rappel:
      'The number returns to the pool immediately; the device will find out at its next check.',
    attr_reprise_motif: 'Reason (required, journaled)',
    attr_reprise_confirmer: 'Reclaim lease',
    attr_reprise_confirmer_lot: 'Reclaim leases',
    attr_reprise_faite: 'Lease reclaimed — the number is back in the pool',
    attr_reprise_lot_faite: '{ok} reclaimed · {ko} without an active lease',
    attr_reprise_super_admin: 'Reclaiming is reserved to the Super-Admin role',
    attr_interlocuteur_enregistre: 'Contact saved',
    attr_interlocuteur_efface: 'Contact cleared',
    attr_exporter: 'Export (CSV)',
    attr_rafraichir: 'Refresh',
    attr_vide_titre: 'The system is ready — no assignment in progress.',
    attr_vide_echus: 'No lease expired over the last thirty days.',
    attr_erreur_chargement: 'The Loader is not responding. Displayed data may be stale.',
    attr_fuseau: 'Times shown in local time ({tz}) — reference clock: the server.',
    attr_sous_ancien_reglage: 'granted under a previous duration setting',
    annuler: 'Cancel',
    dos_eyebrow: 'Assigned number',
    dos_fermer: 'Close file',
    dos_ouvrir: 'Open file',
    dos_identite: 'Identity',
    dos_territoire: 'Territory',
    dos_compte: 'Account',
    dos_releve: 'Transaction history',
    dos_produits: 'Products',
    dos_epargne: 'Savings',
    dos_rattachement: 'Attached to kiosk',
    dos_solde: 'Balance — re-read from account',
    dos_solde_dispo: 'Available',
    dos_statut_compte: 'Account status',
    dos_numero_compte: 'Account no.',
    dos_momo: 'Direct mobile money',
    dos_oui: 'Yes',
    dos_non: 'No',
    dos_langue: 'Language',
    dos_segment: 'Segment',
    dos_nom: 'Name',
    dos_naissance: 'Born',
    dos_situation: 'Marital status',
    dos_profession: 'Occupation',
    dos_piece: 'ID document',
    dos_piece_expire: 'expires on',
    dos_email: 'Email',
    dos_nationalite: 'Nationality',
    dos_adresse: 'Address',
    dos_charger_releve: 'Show history',
    dos_releve_vide: 'No operation.',
    dos_reprendre_pied: 'Reclaim lease',
    dos_frais: 'fees',
    apo_titre: 'Population',
    apo_soustitre: 'Profile combinations, by country — which ones can still serve a contact.',
    apo_libres: 'Free',
    apo_attribues: 'Assigned',
    apo_total: 'Total',
    apo_epuisees: 'Exhausted combinations',
    apo_epuisee_ligne: 'No contact of this profile can receive a number.',
    apo_vide: 'No client exists: Loader seeding is required. This is the system before any real run.',
    apo_femme: 'Female',
    apo_homme: 'Male',
    apo_individuel: 'Individual',
    apo_corporate: 'Corporate',
    vue_titre: 'Overview',
    vue_soustitre: 'Is the system holding? Where are the tensions, what happened.',
    vue_baux_actifs: 'Active leases',
    vue_expirant: 'Expiring within 24 h',
    vue_disponibles: 'Available clients',
    vue_epuisees: 'Exhausted combinations',
    vue_activite: 'Assignments — last 7 days',
    vue_derniers: 'Latest events',
    vue_aucune_activite: 'No assignment over the last seven days.',
    ajr_titre: 'Journal',
    ajr_soustitre: 'Assignments, releases, expirations and refusals — rolling thirty days.',
    ajr_quand: 'When',
    ajr_evenement: 'Event',
    ajr_numero: 'Assigned number',
    ajr_origine: 'Origin',
    ajr_detail: 'Detail',
    ajr_attribution: 'Assignment',
    ajr_rendu: 'Returned by the device',
    ajr_repris: 'Reclaimed from administration',
    ajr_expiration: 'Expiration',
    ajr_refus: 'No client available for this profile',
    ajr_nommage: 'Contact named',
    ajr_appareil: 'device',
    ajr_administration: 'administration',
    ...
    dur_bouton: 'Lease duration',
    dur_titre: 'Lease duration',
    dur_doctrine:
      'Resolved at draw time. Already-assigned leases keep their deadline — a lease is a dated promise.',
    dur_globale: 'Global duration (days)',
    dur_surcharges: 'Per-country overrides',
    dur_surcharge_aucune: 'None — every country follows the global duration.',
    dur_ajouter_surcharge: 'Add an override',
    dur_enregistrer: 'Save',
    dur_super_admin: 'Setting reserved to the Super-Admin role',
    dur_enregistre: 'Duration saved — {n} active lease(s) unchanged',
    dur_jours: 'days',
    dur_suivre_globale: 'follow the global duration',
    ...
    pur_date_inconnue: 'unknown date — not created by us',
    dep_pays: 'Country',
    cmp_aucun_pays_operation: 'No country IN OPERATION on the platform — a company can only exist in a country that exists there.',
    cmp_aller_pousser: 'Push a country',
    cmp_pays_chargement: 'reading countries in operation…',
    cmp_pays_muet: 'config-service did not answer — we cannot tell which countries are in operation. Nothing is offered rather than a guessed list.',
    dep_etat_inconnu: 'state unknown',
    dep_region: 'Region',
    dep_ville: 'City',
    dep_choisir_pays_dabord: 'choose a country first',
    dep_choisir_region_dabord: 'choose a region first',
    dep_choisir_ville_dabord: 'choose a city first',
    inv_col_cree_le: 'Created',
    eco_m_gini: 'Gini',
    ...
    eco_i_disparus: 'kiosk(s) gone from the platform',
    eco_non_verifie: 'Tree NOT verified against the platform — depositary-service did not answer. What you see is our memory of the run, not a confirmation it still exists there.',
